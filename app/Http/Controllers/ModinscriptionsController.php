...
class ModinscriptionsController extends Controller
{
    ...
    public function index()
    {
        ...
        // Pasa los datos a la vista modinscriptions
        return view('modinscriptions.index', compact('uinscriptions'));
    }
    ...
    public function showForm4()
{
    ...
    $anios = Anio::all();
    return view('modinscriptions.lista', compact('carreras','anios'));
}
...
public function filtrarCarreras4(Request $request)
{
    ...
    return view('modinscriptions.index', compact('uinscriptions', 'carreras', 'anios'));
}
