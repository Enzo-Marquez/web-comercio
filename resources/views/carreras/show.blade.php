    ...
    <div class="row justify-content-center">
        <div>
            <div class="card">
                ...
                <div class="card-body">
                    <form id="updateForm" action="{{ route('carreras-update', ['id' => $carrera->id]) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="description" class="form-control"
                                value="{{ $carrera->description }}">
                            <div class="form-text">
                                Ingrese las carreras disponibles para las mesas de exámenes. Estas, una vez creadas, se
                                podrán seleccionar en un desplegable en la creación de la mesa de exámenes.
                            </div>
                        </div>

                        <!-- Botones con modales -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#confirmUpdateModal">Actualizar Carrera</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Está seguro de que desea actualizar la Carrera?
            </div>
